    ...
    Item {
                        ...
                        delegate: Row {
                            ...
                            Repeater {
                                ...
                                delegate: Text {
                                    ...
                                    color: isHoverd ? "#572C27" : "#AF"+ thisTheme.fontColor
        ...
        Row {
            ...
            QCToolTipButton {
                ...
                cursorShape: Qt.PointingHandCursor
                color: "#FF5966"
                iconSource: if(!m_musci_Player.isPaused) return "qrc:/Images/stop.svg"
                else return "qrc:/Images/player.svg"
                hovredColor: "#FF5966"
                iconColor: "#FFFFFF"
                transformOrigin: Item.Center
                onClicked: function (mouse) {
                    if(m_musci_Player.isPaused) {
                        m_musci_Player.play()
                    } else {
                        m_musci_Player.pause()
                    }
                }
                onEntered: {
                    scale = 1.2
